 ...
 * 
 */
package com.jspmyadmin.app.database.export.beans;
...
public class ImportBean extends Bean {
	...
	private String import_to_db = null;
	...
	/**
	 * @return the import_to_db
	 */
	public String getImport_to_db() {
		return import_to_db;
	}

	/**
	 * @param import_to_db
	 *            the import_to_db to set
	 */
	public void setImport_to_db(String import_to_db) {
		this.import_to_db = import_to_db;
	}
